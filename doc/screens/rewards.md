...
**Route:** `/stickers`
**Status:** Implemented with sticker detail sheet (2026-06-20)
...
### New (optional)
- [x] Sticker detail bottom sheet with TTS
...
- Stickers now open a bottom sheet detail card with replayable TTS using built-in Flutter sheet + shared TTS helper.
